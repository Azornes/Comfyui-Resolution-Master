...
export class AspectRatioSelector {
     ...
     * Returns simplified ratio like "16:9", "1:1", etc.
     */
    ...
    /**
     * Dynamically generate SVG icon for any aspect ratio based on actual dimensions
     */
    getAspectRatioIcon(width, height) {
        const iconSize = 20; // SVG viewBox size
        const padding = 2; // Padding inside the icon
        const maxDim = iconSize - padding * 2;
        
        // Calculate aspect ratio
        const aspect = width / height;
        
        // Calculate rectangle dimensions to fit in iconSize x iconSize with padding
        ...
        // Rounded corners - smaller for small rectangles
     ...
     */
    groupPresetsByAspectRatio(presets) {
        const grouped = {};
    ...
    show(presets, options = {}) {
        ...
        // Group presets by aspect ratio
        this.groupedPresets = this.groupPresetsByAspectRatio(this.presets);
